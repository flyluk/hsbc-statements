...
RULES = [
    ...
    {"category": "Cash/Cheque", "priority": 20,
     "match": {"is_cc": 0, "transaction_details_contains_any": [
         ...
         "transaction_details_regex_any": [r"^CASH$"]}},
    ...
    {"category": "Octopus", "priority": 35,
     "match": {"is_cc": 0, "transaction_details_contains_any": ["OCTOPUS"],
    ...
    {"category": "Government", "priority": 37,
     "match": {"is_cc": 0, "transaction_details_contains_any": ["RATING AND VALUATION"]}},
    ...
    {"category": "Personal Transfer", "priority": 43,
     "match": {"is_mortgage": 0,
               ...
               "transaction_details_regex_any": [r"HC\d{10,}", r"\*{2,}"]}},
    {"category": "Utilities", "priority": 44,
     "match": {"is_cc": 0, "transaction_details_contains_any": ["CLP POWER", "DSG ENERGY", "APC COLL-WATER", "HKBN"]}},
